 ...
 * @author aitorpagan
 */
@WebServlet(name = "ServletUploadImage", urlPatterns = {"/ServletUploadImage"})
public class ServletUploadImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(membership.getRole().equalsIgnoreCase("administrador")){
            request.getRequestDispatcher("WEB-INF/Pages/ProfileAdmin.jsp?uploadimage=true").forward(request, response);
            return;
        }       
        ...
        request.getRequestDispatcher("WEB-INF/Pages/Profile.jsp?uploadimage=true").forward(request, response);   
    }
