 ...
 * @author inftel12
 */
@WebServlet(name = "ServletUnPairLatch", urlPatterns = {"/ServletUnPairLatch"})
public class ServletUnPairLatch extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String accountId = membershipFacade.getMembershipAccountId(memberNumber);
        LatchResponse unPairResponse = latch.unpair(accountId);
        membershipFacade.deleteMembershipAccountId(memberNumber);
